...
ALTER TABLE `courses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_course_categories` (`category_id`);
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `fk_course_categories` FOREIGN KEY (`category_id`) REFERENCES `course_categories` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
