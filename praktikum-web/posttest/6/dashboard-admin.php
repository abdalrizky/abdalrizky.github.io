...
$courses = query("SELECT courses.*, course_categories.name AS category FROM courses JOIN course_categories ON courses.category_id = course_categories.id ORDER BY courses.id DESC");
